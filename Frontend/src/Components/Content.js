...
function Content(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className="background-image img-fluid col-md-12"
        style={{
      ...
      <div className="content" style={{ backgroundColor: "#e2e7e6" }}>
        {/* ... (rest of your code) */}
        <div
          className="product-section col-md-12"
          style={{
            display: "flex",
        ...
        >
          {products.map((product) => (
            <div
              ...
              className={`card${product.productId}`}
              style={{
                marginTop: "10px",
                height: "400px",
                width: "23%",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <button
                    className="container-fluid cart-button"
      ...
      <div className="row mt-5">
        ...
        >
          <div
            ...
            className="carousel slide carousel-fade rounded h-10"
